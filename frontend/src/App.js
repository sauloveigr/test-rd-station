...
function App() {
  ...
  return (
    <div className="bg-gray-100 min-h-screen flex flex-col justify-center items-center gap-4 pt-4">
      <h1 className="text-xl sm:text-3xl font-bold ">
        Recomendador de Produtos RD Station
      </h1>
      <div className="bg-white p-8 rounded-lg shadow-md w-full md:w-3/4 lg:w-1/2 flex flex-col  sm:grid sm:grid-cols-1 md:grid-cols-2 gap-8">
